...
def main() -> int:
    ...
    if not prompt_template_file.is_file():
        print(f"Error: Prompt template file does not exist: {prompt_template_file}", file=sys.stderr)
        return 1
    ...
    prompt_template = prompt_template.replace("{tags}", "<auto-generated comma-separated tags>")
